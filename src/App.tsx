...
function StatusButton({ status, active, onClick }: { status: Status; active: boolean; onClick: () => void }) {
  const icons = { unavailable: <X />, tentative: <span>~</span>, available: <Check />, preferred: <Sparkles /> }
